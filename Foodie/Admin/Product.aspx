                                    ...
                                    <div class="col-sm-6 col-md-4 col-lg-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="txtName" runat="server" CssClass="form-control" 
                                                placeholder="Enter ProductName"></asp:TextBox>
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                                                    ErrorMessage="Nmae is Required" ForeColor="Red" Display="Dynamic"
                                            ...
                                            <div class="form-group">
                                             ...
                                             <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" 
                                                 ...
                                                 <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" 
                                                     ErrorMessage="Quantity must be non negitive" ForeColor="Red" Display="Dynamic"
                                        ...
                                        <div class="form-check pl-4">
                                            <asp:CheckBox ID="cbsActive" runat="server" Text="&nbsp; IsActive" 
                                    ...
                                    <div class="col-sm-6 col-md-8 col-lg-8 mobile-inputs">
                                        ...
                                        <div class="card-block table-border-style">
                                            <div class="table-responsive">
                                                ...
                                                <asp:Repeater ID="rCategory" runat="server" OnItemCommand="rProduct_ItemCommand"
